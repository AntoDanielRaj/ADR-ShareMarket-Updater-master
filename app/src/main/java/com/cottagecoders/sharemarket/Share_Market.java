package com.cottagecoders.sharemarket;
...
import com.cottagecoders.sharemarket.DatabaseCode;
...
public class Share_Market extends AppCompatActivity {
    ...
    ArrayList<com.cottagecoders.sharemarket.Security> securities = new ArrayList<>();
    long lastUpdate = 0;
    Handler handler = null;
    Runnable runnable = null;
    com.cottagecoders.sharemarket.DatabaseCode db = null;
...
//   NotificationManager notificationManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sharemarket);
...
//        notificationManager = (NotificationManager) getApplicationContext().getSystemService(NOTIFICATION_SERVICE);
    ...
    private class GetInfo extends AsyncTask<Void, Integer, Integer> {
        ...
        protected void onPreExecute() {
            ...
            if (dialog == null) {
                dialog = new ProgressDialog(Share_Market.this);
